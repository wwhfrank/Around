...
func main() {
	...
	jwtMiddleware := jwtmiddleware.New(jwtmiddleware.Options{
		ValidationKeyGetter: func(token *jwt.Token) (interface{}, error) { // bind ValidationKeyGetter to toke to get secret key in token
